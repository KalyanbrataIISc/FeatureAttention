function leaves = updateLeaves(leaves, fieldRect, minSeparationPx, maxLifeFrames, grid)
...
% computed once by the caller (not here, even though this runs every
% frame) and forwarded to findValidLeafPosition.m on an actual respawn.
